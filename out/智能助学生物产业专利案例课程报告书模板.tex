...
\begin{titlepage}
    ...
    \begin{tabular}{>{\heiti}p{4cm}p{8cm}}
        ...
        推荐提交文件名： & 第17组-课程报告书-葛福荣+蔡子荣.pdf \\
        全文总字数： & 待统计\quad 字 \\
    \end{tabular}
...
可从智能水产养殖、水质监测、鱼类行为识别、病害预警、精准投喂、养殖管理平台等方向说明该专利与本课程生物产业领域的关联性。
...
论文题目建议含有“智能水产养殖”“智慧渔业”“水质监测”“鱼类行为识别”“精准投喂”“病害预警”“人工智能”“专利分析”等类似概念。
...
可从服务国家粮食安全和海洋强国战略、推动水产养殖绿色转型、促进国产智能养殖装备发展、提升生物产业专利转化能力等角度展开。
...
本文拟以“新质生产力背景下生物产业专利转化与助学模式创新”为主题，在课程“智能助学生物产业专利案例”的框架下，选择智能水产养殖病害监测与精准投喂技术作为生物产业专利分析对象。报告首先说明新质生产力、生物产业专利转化和智能助学之间的关系；其次围绕智能水产养殖技术的原理、设备构成、产业应用、优势价值、现存问题和未来发展方向展开分析；再次结合授权专利和期刊文献，讨论其新颖性、创造性、实用性和产业转化价值；最后总结人工智能工具在课程学习、专利检索、文献整理、图表制作和报告撰写中的辅助作用，形成兼具课程要求、专业分析和实践应用价值的课程报告。

\subsection*{中文关键词}
\addcontentsline{toc}{subsection}{中文关键词}

新质生产力；生物产业专利；专利转化；智能助学；智能水产养殖；精准投喂

\subsection*{2.1 研究背景与选题意义}
\addcontentsline{toc}{subsection}{2.1 研究背景与选题意义}

待写作：围绕水产养殖绿色转型、智慧渔业建设、养殖风险预警、饲料利用效率、海洋生物产业升级和国产智能养殖装备发展展开。
...
待写作：水质数据采集、视频图像采集、数据预处理、鱼群行为特征提取、机器学习/深度学习、养殖知识规则、病害风险预测、精准投喂推荐、设备联动和人机协同。
...
待写作：硬件层、数据层、算法层、应用层和安全层；说明水质传感器、高清摄像头、自动投喂机、增氧设备、边缘网关、移动终端、养殖监测看板与云端管理平台之间的关系。
...
待写作：水质在线监测、鱼类摄食行为识别、异常游动识别、病害预警、精准投喂、增氧换水联动控制、养殖记录和质量追溯、远程养殖管理。
...
待写作：从水质监测、病害识别、投喂效率、人工巡塘、记录质量、成本投入、环境保护和技术依赖等维度比较。
...
待写作：总结报告主要发现，说明智能水产养殖病害监测与精准投喂技术的生产价值、生态价值、专利价值和未来发展方向，并说明小组成员在小组工作的工作分配比例。

\subsection*{2分钟口头报告提示}
\addcontentsline{toc}{subsection}{2分钟口头报告提示}

课堂口头报告建议聚焦本部分内容，控制在2分钟内。可依次说明：本组选题与案例对象、核心研究发现、小组成员分工、代表性图表、人工智能工具在课程学习与报告制作中的辅助作用。
